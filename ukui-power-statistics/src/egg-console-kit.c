 ...
 **/
gboolean egg_console_kit_restart(EggConsoleKit * console, GError ** error)
{
    gboolean ret;
    ...
    g_dbus_proxy_call_sync(console->priv->proxy_manager,
			   "Restart",
			   NULL,
			   G_DBUS_CALL_FLAGS_NONE, -1, NULL, &error_local);
 ...
 **/
gboolean egg_console_kit_stop(EggConsoleKit * console, GError ** error)
{
    gboolean ret;
    GError *error_local = NULL;
 ...
 **/
gboolean egg_console_kit_suspend(EggConsoleKit * console, GError ** error)
{
    gboolean ret;
    GError *error_local = NULL;
 ...
 **/
gboolean
egg_console_kit_can_stop(EggConsoleKit * console, gboolean * can_stop,
			 GError ** error)
{
    gboolean ret;
    GError *error_local = NULL;
 ...
 **/
gboolean
egg_console_kit_can_restart(EggConsoleKit * console,
			    gboolean * can_restart, GError ** error)
{
    gboolean ret;
    GError *error_local = NULL;
 ...
 **/
gboolean
egg_console_kit_can_suspend(EggConsoleKit * console,
...
gboolean
egg_console_kit_can_hibernate(EggConsoleKit * console,
			      gboolean * can_hibernate, GError ** error)
{
    GError *error_local = NULL;
    gboolean ret;
    gchar *retval;
 ...
 **/
static void
egg_console_kit_active_changed_cb(GDBusProxy * proxy, gchar * sender_name,
				  gchar * signal_name,
				  GVariant * parameters,
				  gpointer user_data)
{
 ...
 **/
static void egg_console_kit_init(EggConsoleKit * console)
{
    gboolean ret;
    GError *error = NULL;
    guint32 pid;
	...
	g_dbus_proxy_new_for_bus_sync(G_BUS_TYPE_SYSTEM,
				      ...
				      NULL, CONSOLEKIT_NAME,
				      CONSOLEKIT_MANAGER_PATH,
				      CONSOLEKIT_MANAGER_INTERFACE, NULL,
				      &error);
	...
	g_dbus_proxy_new_for_bus_sync(G_BUS_TYPE_SYSTEM,
				      ...
				      CONSOLEKIT_SESSION_INTERFACE, NULL,
				      &error);
    ...
    g_signal_connect(console->priv->proxy_session, "g-signal",
		     G_CALLBACK(egg_console_kit_active_changed_cb),
		     console);
...
EggConsoleKit *egg_console_kit_new(void)
{
	...
	g_object_add_weak_pointer(egg_console_kit_object,
				  &egg_console_kit_object);
    }
