...
typedef struct {
    ...
    void (*alarm_expired) (EggIdletime * idletime, guint timer_id);
...
gboolean egg_idletime_alarm_set(EggIdletime * idletime,
				guint alarm_id, guint timeout);
gboolean egg_idletime_alarm_remove(EggIdletime * idletime, guint alarm_id);
