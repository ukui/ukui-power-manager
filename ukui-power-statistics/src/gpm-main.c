 ...
 **/
static gboolean
gpm_object_register(DBusGConnection * connection, GObject * object)
{
    ...
    dbus_g_error_domain_register(GPM_MANAGER_ERROR, NULL,
 ...
 **/
static void
gpm_main_query_end_session_cb(GpmSession * session, guint flags,
			      GMainLoop * loop)
{
    /* just send response */
 ...
 **/
static void
gpm_main_end_session_cb(GpmSession * session, guint flags,
			GMainLoop * loop)
{
    /* send response */
    gpm_session_end_session_response(session, TRUE, NULL);
...
/*	system_connection = dbus_g_bus_get (DBUS_BUS_SYSTEM, &error);
    ...
    gpm_session_register_client(session, "ukui-power-manager",
